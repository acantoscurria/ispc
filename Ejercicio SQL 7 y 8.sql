...
select sum(monto) as ingresos_julio22 from Historial where EXTRACT(YEAR FROM fecha) = 2022 and EXTRACT(MONTH FROM fecha) = 07;

-- Insertar un nuevo registro en la tabla historial de un perro cuyo ID Perro es igual a 10.

insert into Perro values(10,'Morgan', '2021-06-15', 'M', '34365128');
